...
def test_admin_toggle_verify(client):
    with client.application.app_context():
        # Create admin
        admin = User(username='admin_v', email='admin_v@test.com', role='admin', is_verified=True)
    ...
    # Toggle verification
    response = client.post(f'/admin/user/{user_id}/toggle_verified', follow_redirects=True)
