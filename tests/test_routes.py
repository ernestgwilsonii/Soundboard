...
def test_login_flow(client):
    ...
    response = client.post(
        "/auth/login",
        data={"username": "loginuser", "password": "cat", "submit": "Sign In"},
        follow_redirects=True,
    )
...
def test_logout_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "logoutuser", "password": "cat", "submit": "Sign In"},
    )
...
def test_profile_protected(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "profileuser", "password": "cat", "submit": "Sign In"},
    )
...
def test_soundboard_creation_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "sbuser", "password": "cat", "submit": "Sign In"},
    )
...
def test_view_access_control(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "owner", "password": "cat", "submit": "Sign In"},
    )
...
def test_admin_crud_override(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "bigadmin", "password": "cat", "submit": "Sign In"},
    )

    # Admin edits regular user's board
    response = client.post(
        f"/soundboard/edit/{sb_id}",
        data={"name": "Admin Overwritten", "submit": "Save"},
        follow_redirects=True,
    )
...
def test_admin_required_decorator(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "reguser", "password": "cat", "submit": "Sign In"},
    )
    ...
    client.post(
        "/auth/login",
        data={"username": "adminuser", "password": "cat", "submit": "Sign In"},
        follow_redirects=True,
    )
...
def test_toggle_user_active_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "tgladmin", "password": "cat", "submit": "Sign In"},
    )

    # Toggle to inactive
    response = client.post(
        f"/admin/user/{user_id}/toggle_active", follow_redirects=True
    )
...
def test_toggle_user_role_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "roleadmin", "password": "cat", "submit": "Sign In"},
    )
...
def test_admin_password_reset_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "resetadmin", "password": "cat", "submit": "Sign In"},
    )

    # Reset password
    response = client.post(
        f"/admin/user/{user_id}/reset_password",
        data={
    ...
    response = client.post(
        "/auth/login",
        data={"username": "resetuser", "password": "newpassword", "submit": "Sign In"},
        follow_redirects=True,
    )
    assert b"Logout" in response.data
...
def test_update_profile_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "mailuser", "password": "cat", "submit": "Sign In"},
    )

    response = client.post(
        "/auth/update_profile",
        data={"email": "mail@new.com", "submit": "Update Profile"},
        follow_redirects=True,
    )
...
def test_admin_update_email_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "admin_boss", "password": "cat", "submit": "Sign In"},
    )

    # Update user's email as admin
    response = client.post(
        f"/admin/user/{user_id}/update_email",
        data={"email": "target@new.com", "submit": "Update Email"},
        follow_redirects=True,
    )
...
def test_soundboard_edit_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "edituser", "password": "cat", "submit": "Sign In"},
    )
...
def test_soundboard_delete_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "deluser", "password": "cat", "submit": "Sign In"},
    )
...
def test_sound_upload_flow(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "upuser", "password": "cat", "submit": "Sign In"},
    )
    ...
    # Delete sound
    response = client.post(
        f"/soundboard/sound/{sound_id}/delete", follow_redirects=True
    )
    assert response.status_code == 200
...
def test_sidebar_data_route(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "sidebaruser", "password": "cat", "submit": "Sign In"},
    )
...
def test_change_password_route(client):
    ...
    client.post(
        "/auth/login",
        data={"username": "pwuser", "password": "oldpass", "submit": "Sign In"},
    )
    ...
    response = client.post(
        "/auth/login",
        data={"username": "pwuser", "password": "newpassword", "submit": "Sign In"},
        follow_redirects=True,
    )
    assert b"Logout" in response.data
