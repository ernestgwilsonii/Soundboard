...
def test_share_button_absence_private(client):
    ...
    # Login
    client.post('/auth/login', data={'username': 'privateuser', 'password': 'cat', 'submit': 'Sign In'}) # Oh wait user has no password set in this test setup?
    ...
    client.post('/auth/login', data={'username': 'privateuser', 'password': 'pass', 'submit': 'Sign In'})
